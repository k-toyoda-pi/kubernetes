...
function create-etcd-certs {
  ...
  ETCD_CA_CERT_BASE64=$(gzip < "ca.pem" | base64 | tr -d '\r\n')
  ETCD_PEER_KEY_BASE64=$(base64 "peer-key.pem" | tr -d '\r\n')
  ETCD_PEER_CERT_BASE64=$(gzip < "peer.pem" | base64 | tr -d '\r\n')
  popd
}
...
function create-etcd-apiserver-certs {
  ...
  ETCD_APISERVER_CA_CERT_BASE64=$(gzip < "ca.pem" | base64 | tr -d '\r\n')
  ETCD_APISERVER_SERVER_KEY_BASE64=$(base64 "etcd-apiserver-server-key.pem" | tr -d '\r\n')
  ETCD_APISERVER_SERVER_CERT_BASE64=$(gzip < "etcd-apiserver-server.pem" | base64 | tr -d '\r\n')
  ETCD_APISERVER_CLIENT_KEY_BASE64=$(base64 "etcd-apiserver-client-key.pem" | tr -d '\r\n')
  ETCD_APISERVER_CLIENT_CERT_BASE64=$(gzip < "etcd-apiserver-client.pem" | base64 | tr -d '\r\n')
  popd
}
